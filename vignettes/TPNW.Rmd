...
A web search led me to a 2012-01-15 article on ["Scraping table from any web page with `R` or `CloudStat`"](https://www.r-bloggers.com/scraping-table-from-any-web-page-with-r-or-cloudstat/).  This suggests using [`XML::readHTMLTable`https://www.rdocumentation.org/packages/XML/versions/3.99-0.2/topics/readHTMLTable](https://www.rdocumentation.org/packages/XML/versions/3.99-0.2/topics/readHTMLTable).  
