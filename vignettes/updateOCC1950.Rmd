...
In any event, after each data selection, I was given an "estimated size" for the extract (5340 MB for one trial). I entered something to "Describe your extract". Then I clicked, "Submit extract".  The IPUMS web site responded saying, "Your extract request has been submited.  You will be notified by email at (the email address I had given them) when it has been created."  Under "Data", it said, "Processing...".  
