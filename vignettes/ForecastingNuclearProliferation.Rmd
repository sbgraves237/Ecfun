...
#NucSt <- paste0('CN = China, ', 
# 'FR, GB (overplotted) = France + UK, ',
#  ' IL = Israel,\nIN = India, KP = North Korea, ', 
#  'PK = Pakistan, RU = Russia')
#title(xlab=NucSt, line=3.5, cex.lab=0.85)
...
Next, we compute central 60 and 80 percent confidence limits plus 80 percent prediction, and (0.8, 0.8) tolerance limits for future nuclear proliferation based on `fitProlif` and `fitProlif4`.[^cipiti]
...
<!--I wanted to put "[^cipiti]" here.  However, that duplicated a relatively large footnote; unacceptable.-->
