...
4.  Select TL10 and TU90 to include at least 80 percent of `cumsum`med Poisson simulations about each of L10 and U90 individually.  We do this as follows:  
    ...
    4.1.  Set the initial value for `TU90` as the 80th percentile of the distributions of the simulated trajectories around `U90`.  Similarly set the initial value for `TL10` as the 20th percentile of the distributions of the simulated trajectories around `L10`.  
