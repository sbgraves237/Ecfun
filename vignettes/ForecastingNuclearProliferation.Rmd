...
#  fT_date <- c(xpast$firstTest[1], xpast$firstTest, fT_end)
...
# 4.  Today in 2020 
# 5.  Poisson data:  Model as a Poisson count each year since 1945
# 6.  BMA:  79% const.;  21% linear
...
# svg format is not supported for Google slides
  png('NucWeaponStates_nucProlifPred11.png', width=960)
  op <- par(cex=1.7, cex.axis=1.4, 
...
if(save_svg){
# 6.  BMA: 79% const.; 21% lin. w annotations
  print(getwd())
#  svg('NucWeaponStates_nucProlifPred1.svg')
# svg format is not supported for Google slides
