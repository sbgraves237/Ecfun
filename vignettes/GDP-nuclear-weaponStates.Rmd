...
We want to plot the GDPs of the current nuclear-weapon states since the first country made a substantive commitment to develop them, `r min(Ecdat::nuclearWeaponStates[, 'startNucPgm'])`.  We'll plot:
